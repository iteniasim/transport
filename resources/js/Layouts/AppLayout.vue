            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink v-for="nav in navList" :key="`nav-${nav.name}`" :href="route(nav.name)" :active="route().current(nav.name)">
                                    {{ nav.label }}
                                </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink v-for="nav in navList" :key="`nav-${nav.name}`" :href="route(nav.name)"
                            :active="route().current(nav.name)">
                            {{ nav.label }}
                        </ResponsiveNavLink>
                    </div>

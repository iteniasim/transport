    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <TextInput id="password_confirmation" v-model="form.password_confirmation" type="password" class="block w-full mt-1" required
            ...
            <div class="mt-4">
                ...
                <div class="mt-1">
                    <select id="role" name="role" autocomplete="role-name" v-model="form.role"
                        class="block w-full text-gray-900 border-0 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
